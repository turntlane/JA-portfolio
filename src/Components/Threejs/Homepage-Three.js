...
class Globe extends Component {
  ...
  componentDidMount() {
    ...
    const dotMaterial = new THREE.PointsMaterial({ color: "black" });
    ...
    var directionalLight = new THREE.PointLight('grey', 1, 150);
    ...
    const ambientLight = new THREE.AmbientLight("black", 0.2);
